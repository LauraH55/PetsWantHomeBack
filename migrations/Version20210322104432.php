 ...
 */
final class Version20210322104432 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE race ADD species_id INT DEFAULT NULL, DROP species');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE race ADD species SMALLINT NOT NULL, DROP species_id');
    }
}
